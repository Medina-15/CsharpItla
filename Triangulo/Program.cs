namespace Triangulo
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Este programa calcula el area de los triangulos, muestra sus dimensiones y luego cuenta a los que excedan un area de 12cm cuadrados.");
            ...
            try
            {
                ...
                for (int i = 1; i <= triangulos; i++)
                {
                    ...
                    Console.WriteLine($"La base del triangulo {i} es igual a {Base}, su altura es: {altura} lo que da resultado a un area de {area}");

                    Console.WriteLine("------------------------------------------------------------------------------");

                }

                Console.WriteLine($"La cantidad de triangulos que exceden los 12 centimetros cuadrados son: {excluidos}");
            }
